...
import 'package:uuid/uuid.dart';
                ...
                abstract class RustLibApiImplPlatform extends BaseApiImpl<RustLibWire> {
                  ...
                  CrossPlatformFinalizerArg get rust_arc_decrement_strong_count_ResultTypePtr => wire._rust_arc_decrement_strong_count_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerResultTypePtr;



                  @protected AnyhowException dco_decode_AnyhowException(dynamic raw);

@protected ResultType dco_decode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerResultType(dynamic raw);
...
@protected ResultType dco_decode_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerResultType(dynamic raw);

@protected RustStreamSink<String> dco_decode_StreamSink_String_Sse(dynamic raw);

@protected RustStreamSink<EventToUI> dco_decode_StreamSink_event_to_ui_Sse(dynamic raw);
...
@protected EventToUI dco_decode_event_to_ui(dynamic raw);
...
@protected ResultType sse_decode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerResultType(SseDeserializer deserializer);
...
@protected ResultType sse_decode_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerResultType(SseDeserializer deserializer);

@protected RustStreamSink<String> sse_decode_StreamSink_String_Sse(SseDeserializer deserializer);

@protected RustStreamSink<EventToUI> sse_decode_StreamSink_event_to_ui_Sse(SseDeserializer deserializer);
...
@protected EventToUI sse_decode_event_to_ui(SseDeserializer deserializer);
...
@protected void sse_encode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerResultType(ResultType self, SseSerializer serializer);
...
@protected void sse_encode_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerResultType(ResultType self, SseSerializer serializer);

@protected void sse_encode_StreamSink_String_Sse(RustStreamSink<String> self, SseSerializer serializer);

@protected void sse_encode_StreamSink_event_to_ui_Sse(RustStreamSink<EventToUI> self, SseSerializer serializer);
...
@protected void sse_encode_event_to_ui(EventToUI self, SseSerializer serializer);
...
// Section: wire_class
        ...
        class RustLibWire implements BaseWire {
            ...
            void rust_arc_increment_strong_count_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerResultType(
            ...
            late final _rust_arc_increment_strong_count_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerResultTypePtr = _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>)>>('frbgen_flutter_hbb_rust_arc_increment_strong_count_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerResultType');
            late final _rust_arc_increment_strong_count_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerResultType = _rust_arc_increment_strong_count_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerResultTypePtr.asFunction<void Function(ffi.Pointer<ffi.Void>)>();

            void rust_arc_decrement_strong_count_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerResultType(
              ffi.Pointer<ffi.Void> ptr,
            ) {
            ...
            late final _rust_arc_decrement_strong_count_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerResultTypePtr = _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>)>>('frbgen_flutter_hbb_rust_arc_decrement_strong_count_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerResultType');
            late final _rust_arc_decrement_strong_count_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerResultType = _rust_arc_decrement_strong_count_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerResultTypePtr.asFunction<void Function(ffi.Pointer<ffi.Void>)>();
