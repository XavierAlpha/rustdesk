...
class _FileManagerPageState extends State<FileManagerPage>
                ...
                body: CamelliaBackdrop(
                  child: Row(
                    children: [
                      ...
                      Flexible(flex: 2, child: _workspacePane(statusList())),
                    ],
                  ),
                ),
              ),
  ...
  Widget _workspacePane(Widget child) {
    return DecoratedBox(
      decoration: BoxDecoration(
        color: Theme.of(context).colorScheme.surface,
        border: Border(right: BorderSide(color: AppVisual.border(context))),
      ),
            ...
            Column(
              ...
              children: [
                Row(
                  ...
                  children: [
                    getIcon(item).marginSymmetric(horizontal: 10, vertical: 12),
                    Expanded(
                      child: Column(
                        mainAxisSize: MainAxisSize.min,
...
class _FileManagerViewState extends State<FileManagerView> {
            ...
            children: [
                  ...
                  () => ElevatedButton.icon(
                    ...
                    label: InkWell(
                      ...
                      onTapDown: (e) {
                        ...
                        uploadButtonTapPosition = RelativeRect.fromLTRB(
                          x,
                          y,
                          x,
                          y,
              ...
              Obx(
                () => ElevatedButton.icon(
                  ...
                  onPressed: SelectedItems.valid(selectedItems.items)
                      ? () {
                          final otherSideData = controller
  ...
  Widget menu({bool isLocal = false}) {
    ...
    final List<MenuEntryBase<String>> items = [
      ...
      MenuEntryButton(
        childBuilder: (style) => Text(translate("Unselect All"), style: style),
    ...
    return ListSearchActionListener(
      ...
      child: Obx(() {
        ...
        return Column(
          children: [
            // Header
            Row(children: [Expanded(child: _buildFileBrowserHeader(context))]),
            // Body
            Expanded(
        ...
        : Row(
            ...
            children: [
              ...
              ActionIcon(
                ...
                onTap: () async {
                  final renderBox =
                      _locationBarKey.currentContext?.findRenderObject()
                          as RenderBox;
                  ...
                  if (isPeerWindows) {
                    ...
                    try {
                      ...
                      final fd = await controller.fileFetcher.fetchDirectory(
                        "/",
                        isLocal,
                        showHidden,
                      );
