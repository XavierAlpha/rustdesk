...
class MyTheme {
  ...
  static dynamic _dialogThemeCompat(Color borderColor) {
    ...
    final fallbackTheme = ThemeData.fallback().dialogTheme;
    return fallbackTheme.runtimeType.toString() == 'DialogThemeData'
        ? (theme as dynamic).data
        : theme;
  }
  ...
  static dynamic _tabBarThemeCompat(Color labelColor) {
    ...
    final fallbackTheme = ThemeData.fallback().tabBarTheme;
    return fallbackTheme.runtimeType.toString() == 'TabBarThemeData'
        ? (theme as dynamic).data
        : theme;
  }
