...
//  https://github.com/CamelliaCorp/CamelliaIddDriver/blob/b370aad3f50028b039aad211df60c8051c4a64d6/CamelliaIddDriver/CamelliaIddDriver.inf#LL73C1-L73C40
pub const CAMELLIA_IDD_DEVICE_STRING: &'static str = "CamelliaIddDriver Device\0";
pub const AMYUNI_IDD_DEVICE_STRING: &'static str = "USB Mobile Monitor Virtual Display\0";

const IDD_IMPL: &str = IDD_IMPL_AMYUNI;
const IDD_IMPL_CAMELLIA: &str = "camellia_idd";
...
pub fn get_cur_device_string() -> &'static str {
    match IDD_IMPL {
        IDD_IMPL_CAMELLIA => CAMELLIA_IDD_DEVICE_STRING,
...
pub fn plug_in_headless() -> ResultType<()> {
    match IDD_IMPL {
        IDD_IMPL_CAMELLIA => rustdesk_idd::plug_in_headless(),
    ...
    match IDD_IMPL {
        IDD_IMPL_CAMELLIA => {
            ...
            if !virtual_displays.is_empty() {
                map.insert(
                    "camellia_virtual_displays".into(),
...
pub fn plug_in_monitor(idx: u32, modes: Vec<virtual_display::MonitorMode>) -> ResultType<()> {
    match IDD_IMPL {
        IDD_IMPL_CAMELLIA => rustdesk_idd::plug_in_index_modes(idx, modes),
...
pub fn plug_in_peer_request(modes: Vec<Vec<virtual_display::MonitorMode>>) -> ResultType<Vec<u32>> {
    match IDD_IMPL {
        IDD_IMPL_CAMELLIA => rustdesk_idd::plug_in_peer_request(modes),
        IDD_IMPL_AMYUNI => {
...
pub fn plug_out_monitor_indices(
    ...
    match IDD_IMPL {
        IDD_IMPL_CAMELLIA => rustdesk_idd::plug_out_peer_request(indices),
        IDD_IMPL_AMYUNI => {
...
pub fn reset_all() -> ResultType<()> {
    match IDD_IMPL {
        IDD_IMPL_CAMELLIA => rustdesk_idd::reset_all(),
...
pub mod rustdesk_idd {
    ...
    fn get_device_names() -> Vec<String> {
        windows::get_device_names(Some(super::CAMELLIA_IDD_DEVICE_STRING))
    }
