...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Language", "Γλώσσα"),
        ("Keep Camellia background service", "Διατήρηση της υπηρεσίας παρασκηνίου του Camellia"),
        ...
        ("Show Camellia", "Εμφάνιση του Camellia"),
        ...
        ("About Camellia", "Πληροφορίες για το Camellia"),
        ...
        ("upgrade_remote_Camellia_client_to_{}_tip", "Αναβαθμίστε τον πελάτη Camellia στην έκδοση {} ή νεότερη στην απομακρυσμένη πλευρά!"),
