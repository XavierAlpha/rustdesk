...
pub mod sync;
pub use http_client::{
    create_http_client, create_http_client_async, create_http_client_async_with_tls,
    create_http_client_async_with_url, create_http_client_async_with_url_strict,
