...
///
/// Note:
/// On linux, we use dbus to communicate between multiple Camellia processes.
...
const DBUS_NAME: &str = "org.camellia.camellia";
...
impl fmt::Display for DbusError {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(f, "Camellia DBus Error: {}", self.0)
    }
}
...
/// `dbus-send --session --print-reply --dest=org.camellia.camellia /dbus org.camellia.camellia.NewConnection string:'PEER_ID'`
