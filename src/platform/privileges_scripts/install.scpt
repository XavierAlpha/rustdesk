on run {daemon_file, agent_file, user}
  ...
  set prefs_dir to "/Users/" & user & "/Library/Preferences/com.camellia/"
  ...
  set sh3 to "cp -rf " & prefs_toml & " /var/root/Library/Preferences/com.camellia/;"

  set sh4 to "cp -rf " & prefs2_toml & " /var/root/Library/Preferences/com.camellia/;"

  set sh5 to "launchctl bootout system/com.camellia_service 2>/dev/null || launchctl unload -w /Library/LaunchDaemons/com.camellia_service.plist 2>/dev/null || true; launchctl bootstrap system /Library/LaunchDaemons/com.camellia_service.plist 2>/dev/null || launchctl load -w /Library/LaunchDaemons/com.camellia_service.plist;"
