<p align="center">
  ...
  <b>Kell a segítséged, hogy lefordítsuk ezt a README-t, <a href="https://github.com/CamelliaCorp/camellia/tree/master/src/lang">a Camellia UI-t</a> és a <a href="https://github.com/CamelliaCorp/camellia">Dokumentációt</a> az anyanyelvedre</b>
</p>
...
A Camellia egy távoli elérésű asztali szoftver, Rust-ban írva. Működik mindenféle konfiguráció nélkül, feltelepítéssel, vagy anélkül. Az adataidat teljesen te kezeled, nincs szükség aggódásra a harmadik felek miatt. Használhatod a Camellia punblikus randevú/relay szervereit, [hostolhatsz sajátot](https://camellia.aimmv.com/server), vagy akár [írhatsz is egyet](https://github.com/CamelliaCorp/camellia).

![image](./assets/171661982-430285f0-2e12-4b1d-9957-4a58e375304d.png)

A Camellia szívesen fogad minden contributiont, támogatást mindenkitől. Lásd a [`docs/CONTRIBUTING.md`](CONTRIBUTING.md) fájlt a kezdéshez.

[**Hogyan működik a Camellia?**](https://github.com/CamelliaCorp/camellia/wiki/How-does-Camellia-work%3F)

[**BINARY LELTÖLTÉS**](https://github.com/CamelliaCorp/camellia/releases)
...
## [Építés](https://camellia.aimmv.com/docs/hu/dev/build/)
...
Ezután, minden egyes alkalommal amikor meg kell építened a Camellia-et, futtasd a kövezkező parancsot:
