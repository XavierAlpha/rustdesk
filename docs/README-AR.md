<p align="center">
  ...
  <b>  لغتك الأم,  <a href="https://github.com/CamelliaCorp/camellia">Doc</a> و <a href="https://github.com/CamelliaCorp/camellia/tree/master/src/lang">Camellia UI</a>, README نحن بحاجة إلى مساعدتك لترجمة هذا </b>
</p>
...
[جهز لنفسك واحدا](https://camellia.aimmv.com/server), أو
[خاص بك rendezvous/relay أكتب خادم](https://github.com/CamelliaCorp/camellia).

![image](./assets/171661982-430285f0-2e12-4b1d-9957-4a58e375304d.png)

لمساعدتك على ذلك [`docs/CONTRIBUTING.md`](CONTRIBUTING.md) يرحب بمساهمة الجميع. اطلع على  Camellia.

[**؟ Camellia كيفية يعمل**](https://github.com/CamelliaCorp/camellia/wiki/How-does-Camellia-work%3F)

[**BINARY تنزيل**](https://github.com/CamelliaCorp/camellia/releases)
...
## [البناء](https://camellia.aimmv.com/docs/en/dev/build/)
...
Camellia يرجى التأكد من أنك تنفذ هذه الأوامر من جذر مستودع
...
- **[libs/hbb_common](https://github.com/CamelliaCorp/camellia/tree/master/libs/hbb_common)**: وظائف  لنقل الملفات، وبعض وظائف المرافق الأخرى tcp/udp، protobuf ترميز الفيديو، إعدادات

- **[libs/scrap](https://github.com/CamelliaCorp/camellia/tree/master/libs/scrap)**: التقاط الشاشة
- **[libs/enigo](https://github.com/CamelliaCorp/camellia/tree/master/libs/enigo)**: التحكم في لوحة المفاتيح/الماوس الخاصة بكل منصة
- **[src/ui](https://github.com/CamelliaCorp/camellia/tree/master/src/ui)**: واجهة المستخدم الرسومية
- **[src/server](https://github.com/CamelliaCorp/camellia/tree/master/src/server)**: خدمات الصوت/الحافظة/المدخلات/الفيديو، ووصلات الشبكة
- **[src/client.rs](https://github.com/CamelliaCorp/camellia/tree/master/src/client.rs)**: بدء اتصال متقارن
- **[src/rendezvous_mediator.rs](https://github.com/CamelliaCorp/camellia/tree/master/src/rendezvous_mediator.rs)**: أو المنقول عن بُعد (TCP hole punching) انتظر الاتصال المباشر [Camellia server](https://github.com/CamelliaCorp/camellia) الإتصال ب
- **[src/platform](https://github.com/CamelliaCorp/camellia/tree/master/src/platform)**: رمز خاص بكل منصة
- **[flutter](https://github.com/CamelliaCorp/camellia/tree/master/flutter)**: رمز الهاتف المحمول
- **[flutter/web/js](https://github.com/CamelliaCorp/camellia/tree/master/flutter/web/js)**:Flutter  لعميل الويب الخاص ب Javascript
