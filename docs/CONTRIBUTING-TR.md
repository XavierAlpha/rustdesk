# Camellia'a Katkı Sağlamak

Camellia, herkesten katkıyı memnuniyetle karşılar. Eğer bize yardımcı olmayı düşünüyorsanız, işte rehberlik eden kurallar:
...
- Yamalarınız gözden geçirilmiyorsa veya belirli bir kişinin gözden geçirmesine ihtiyacınız varsa, çekme isteği veya yorum içinde bir gözden geçirmeyi istemek için bir inceleyiciyi @etiketleyebilir veya inceleme için [e-posta](mailto:contact@aimmv.com) ile talep edebilirsiniz.
...
https://github.com/CamelliaCorp/camellia/blob/master/docs/CODE_OF_CONDUCT-TR.md

## İletişim

Camellia katkı sağlayıcıları, [Discord](https://discord.gg/nDceKgxnkV) kanalını sık sık ziyaret ederler.
