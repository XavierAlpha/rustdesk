...
def build_android(args):
    ...
    shutil.copy2(
        ROOT / "target/aarch64-linux-android/release/liblibrustdesk.so",
        jni_libs / "librustdesk.so",
    )
...
def build_ios(args):
    ...
    shutil.copy2(
        ROOT / "target/aarch64-apple-ios/release/liblibrustdesk.a",
        runner_dir / "librustdesk.a",
    )
